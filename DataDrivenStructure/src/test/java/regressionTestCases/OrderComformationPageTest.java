...
import pages.OrderComformationPage;
...
public class OrderComformationPageTest extends BaseClass{
	...
	OrderComformationPage orderconformpage;
	...
	@Test
	public void verifyorderComformationMsg() {
		...
		orderconformpage=new OrderComformationPage();
		orderconformpage.orderComformationMsg();
	}
